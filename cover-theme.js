...
(() => {
  ...
  function installStyles(){if(document.getElementById(STYLE_ID))return;const style=document.createElement('style');style.id=STYLE_ID;style.textContent=`
    ...
    .book[data-cover-theme-ready="1"] .book-body{position:relative;isolation:isolate;background:transparent}
    .book[data-cover-theme-ready="1"] .book-body::before{content:"";position:absolute;inset:7px 7px 7px;border-radius:14px;background:rgba(232,245,237,.90);border:1px solid rgba(157,194,169,.78);box-shadow:0 5px 16px rgba(38,87,57,.12);z-index:-1}
