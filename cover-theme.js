...
(() => {
  ...
  function loadBookshelfRepair(){if(document.getElementById('bookshelf-repair-script'))return;const script=document.createElement('script');script.id='bookshelf-repair-script';script.src='bookshelf-repair.js?v=20260918-progress1';document.head.appendChild(script);}
