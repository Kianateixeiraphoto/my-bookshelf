...
(() => {
  ...
  function loadUnreadSection(){if(document.getElementById('unread-section-script'))return;const script=document.createElement('script');script.id='unread-section-script';script.src='unread-section.js?v=20260819-fix5';script.defer=true;document.head.appendChild(script);}
